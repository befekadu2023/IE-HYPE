...
jacobian_inv_hype.o:: mat_inv_globvars.mod modvar.mod hypevariables.mod
...
soil_proc.o    : mat_inv_globvars.mod jacobian_inv_hype.mod hypevariables.mod modvar.mod statetype_module.mod general_water_concentration.mod general_functions.mod npc_soil_processes.mod atmospheric_processes.mod hype_indata.mod
